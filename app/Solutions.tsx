        ...
        <div className="justify-start items-start  inline-flex">
          <div className="flex-col justify-start items-start gap-[30px]">
            <button className="flex justify-start items-start">
              <Link
                href={""}
                className="p-6 border-l-2 border-orange-400 flex items-center gap-5 "
              >
                ...
                <div className="flex-col justify-center items-start gap-2.5">
            ...
            <button className="flex justify-start items-start">
              <Link
                href={""}
                className="p-6 flex justify-start items-center gap-5"
              >
                <div className="w-20 h-20 flex justify-center items-center">
                  <Image
                    src={"/programmer.svg"}
              ...
              <div className="flex-col justify-start items-start gap-5">
                ...
                <div className="flex-col justify-start items-start gap-2.5">
                  ...
                  <p className="w-full text-zinc-700 text-sm font-normal leading-normal">
                    Experienced teams and an agile framework, we prioritize the
            ...
            <div className="w-[785px] h-[284px] relative">
              <div className="w-[210px] h-[100px] left-0 top-0 absolute">
                ...
                <p className="w-[210px] left-0 top-[40px] absolute text-zinc-700 text-xs font-normal  leading-tight">
                  We break down your project into iterations to cover all of the
          ...
          {/* <div className="w-[784px] h-[390px] flex-col justify-start items-start gap-10 inline-flex ">
            ...
            <div className="flex flex-wrap justify-start items-start gap-8">
              ...
              <div className="flex-col gap-2.5 inline-flex">
                ...
                <p className="w-56 text-zinc-700 text-xs font-normal leading-tight">
                  Quality assurance helps find weak spots in customer’s journey
                  as well.
                </p>
              </div>
              <div className="flex-col gap-2.5 inline-flex">
                ...
                <p className="w-56 text-zinc-700 text-xs font-normal leading-tight">
                  Seamless and super-engaging user experience is the key to win
                  the hearts of your customers.
                </p>
              </div>
            </div>
          </div> */}
          <div className="w-[787px] h-[349px] flex-col justify-start items-start gap-10 inline-flex">
            ...
            <div className="flex flex-wrap w-[787px] justify-start items-start gap-[27px]">
              ...
              <div className="px-5 py-2.5 bg-white rounded-[5px] shadow justify-start items-center gap-2.5 flex">
                ...
                <div className="flex-col justify-start items-start gap-[5px] inline-flex">
                  ...
                  <p className="w-[270px] text-indigo-500 text-sm font-normal leading-[17.50px]">
                    Ensuring Best Performance and Quality Assurance Excellence.
                  </p>
                </div>
              </div>
              <div className="px-5 py-2.5 bg-white rounded-[5px] shadow justify-start items-center gap-2.5 flex">
