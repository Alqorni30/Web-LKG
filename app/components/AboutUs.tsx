...
const AboutUs = () => {
  return (
    <>
      ...
      {/* <section
        id="about"
        className="px-4 sm:px-6 md:px-8 py-8 md:py-16 lg:py-24"
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="lg:p-5">
            <h3 className="text-center lg:text-left font-bold text-primary text-xl md:text-2xl lg:text-2xl mb-3 md:mb-5">
              Who we are?
            </h3>
            <h1 className="text-center lg:text-left font-bold text-lg md:text-4xl lg:text-4xl mb-6 md:mb-11">
              We are just a bunch of practitioners working in the{" "}
              <span className="text-pink">technology industry.</span>
            </h1>
            <p className="text-sm md:text-base lg:text-base">
