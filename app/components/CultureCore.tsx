        ...
        <div className="max-w-7xl container mx-auto">
          ...
          <div className="flex justify-center items-center py-12">
            <div className="gap-7 flex justify-center items-center lg:flex-nowrap flex-wrap px-20 w-full">
              <div className="s:h-[280px] xs:h-[320px] lg:w-[290px] lg:h-[390px] md:w-[290px] md:h-[350px] px-5 py-[30px] bg-card rounded-[20px] flex-col justify-start items-start gap-5 inline-flex">
                ...
                <div className="self-stretch h-[108px] flex-col justify-start items-start gap-2.5 flex">
                  <div className="self-stretch text-zinc-700 s:text-sm xs:text-xl text-xl font-bold  leading-[25px]">
                    Expertise & Experience in the industry
                  </div>
                  <div className="self-stretch  text-zinc-700 s:text-xs xs:text-sm text-sm font-normal  leading-normal">
                    Have in-depth understanding in various industrial sectors
                  </div>
                </div>
              </div>
              
              <div className="s:h-[310px] xs:h-[320px] lg:w-[290px] lg:h-[390px] md:w-[290px] md:h-[350px] px-5 py-[30px] bg-card rounded-[20px] flex-col justify-start items-start gap-5 inline-flex">
                <div className="w-20 h-20 justify-center items-center inline-flex">
              ...
              <div className="xs:h-[320px] lg:w-[290px] lg:h-[390px] md:w-[290px] md:h-[350px] px-5 py-[30px] bg-card rounded-[20px] flex-col justify-start items-start gap-5 inline-flex">
                <div className="w-20 h-20 justify-center items-center inline-flex">
              ...
              <div className="xs:h-[380px] lg:w-[290px] lg:h-[390px] md:w-[290px] md:h-[350px] px-5 py-[30px] bg-card rounded-[20px] flex-col justify-start items-start gap-5 inline-flex">
                <div className="w-20 h-20 justify-center items-center inline-flex">
